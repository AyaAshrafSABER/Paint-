 ...
 */
package eg.edu.alexu.csd.oop.draw.cs02.json;
...
import eg.edu.alexu.csd.oop.draw.cs02.json.parser.JSONParser;
import eg.edu.alexu.csd.oop.draw.cs02.json.parser.ParseException;
...
public class JSONValue {
     ...
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.parser.json.simple.parser.JSONParser#parse(Reader)
     ...
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.parser.json.simple.parser.JSONParser
     * 
     * @param in
     * @return Instance of the following: org.json.simple.JSONObject,
     *         org.json.simple.JSONArray, java.lang.String, java.lang.Number,
     ...
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONObject#writeJSONString(Map, Writer)
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
     ...
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONObject#toJSONString(Map)
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONArray#toJSONString(List)
     * 
     * @param value
