...
public class JSONObject extends HashMap
     ...
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONValue#writeJSONString(Object, Writer)
     * 
     * @param map
     * @param out
     */
     ...
     * top level.
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONValue#toJSONString(Object)
     * 
     * @param map
     ...
     * compatibility here.
     * 
     * @see eg.edu.alexu.csd.oop.draw.cs02.json.json.simple.JSONValue#escape(String)
     * 
     * @param s
     * @return
     */
