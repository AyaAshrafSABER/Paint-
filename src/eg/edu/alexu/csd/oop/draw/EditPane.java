...
import eg.edu.alexu.csd.oop.draw.Paint.Painter;
...
public class EditPane extends Canvas{
     ...
     */
    ArrayList<Shape> smallCanvasShapes = new ArrayList<Shape>();
	...
	try {
	    smallCanvasShapes.add((Shape) newChosenShape.clone());
	...
	btnNewButton.addActionListener(new ActionListener() {
		...
		DrawingEngineSinglton.drawingEngine()
